...
@section('content')
    ...
    <section class="content">
        <div class="row">
            ...
            <div class="{!! ((Sentinel::check() && Sentinel::inRole('admin')) ? '' : 'hide') !!} col-lg-3 col-md-6 col-sm-6 margin_10 animated fadeInUpBig">
                        ...
                        <div class="col-xs-12 pull-left nopadmar">
                            <div class="row">
                                <div class="square_box col-xs-7 pull-left">
                                    ...
                                    <div class="number" id="myTargetElement2" data-min="1" data-max="{{ App\Models\Order::count()}}"></div>
                                </div>
                        ...
                        <div class="col-xs-12 pull-left nopadmar">
                            <div class="row">
                                <div class="square_box col-xs-7 pull-left">
                                    ...
                                    <div class="number" id="myTargetElement4" data-min="1" data-max="{{ App\Models\Candidate::count()}}"></div>
                                </div>
